...
export default function OnboardingPage() {
  ...
  return <PageShell>
    <section className="setup-layout"><aside className="setup-aside"><Link className="site-brand compact" to="/"><span className="brand-square">→</span>向前</Link><div><span className="section-kicker">开始之前</span><h1>用两分钟，<br />让建议从你出发。</h1><p>不填写成绩或联系方式；完成后同步到当前账号。</p></div><ol><li className={step === 1 ? "is-active" : ""}><span>01</span>确认阶段</li><li className={step === 2 ? "is-active" : ""}><span>02</span>给出起点</li></ol><Link className="aside-link" to="/teacher/dashboard">我是教师，查看模拟洞察 <ArrowRight size={15} /></Link></aside>
