...
import { resolveOnboardingDestination, useCareerStore } from "../store/careerStore";
...
export default function OnboardingPage() {
  ...
  const directionCalibrated = useCareerStore((state) => Boolean(state.awakening.calibratedAt || state.awakening.selectedDirectionId));
  ...
  async function submit(event: React.FormEvent) {
    ...
    try {
      ...
      await syncCareerNow();
      navigate(resolveOnboardingDestination(profile, directionCalibrated));
    } catch {
